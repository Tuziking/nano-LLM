...
if __name__ == '__main__':   
    ...
    wandb.init(project="nanoLLM", name="moe_model1_6epoch")
    tokenizer = AutoTokenizer.from_pretrained("./tokenizer", use_fast=True)
    args = TrainingArguments(output_dir='checkpoints/moe_model1_6epoch', 
                            num_train_epochs=6, 
                            do_train=True, 
    ...
    trainer.save_model('./saves/moe_model1_6epoch')
    tokenizer.save_pretrained('./saves/moe_model1_6epoch/tokenizer')  # 保存 tokenizer